...
if len(selected_sector) == 0:
    ...
    st.write('This dashboard consists of stock market visualization of companies in the list S&P 500 given in '
             'Wikipedia. Click here to see the [list](https://en.wikipedia.org/wiki/List_of_S%26P_500_companies).')
    st.write('The companies are grouped by their sectors and identified by their tickers. Select the Sector from the'
